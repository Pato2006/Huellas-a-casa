...
En caso de pullear y que se pisen algunas linear, el codigo va a estar en MERGIN, hay que ir al archivo en mergin y corregir las lineas 
(van a estar indicadas por codigos como &&!*@#K* -codigo- *(@#*&SAD) hay que sacar esas lineas solamente y fijarse que no se haya borrado nada del codigo
despues si, commitear y pushear (siempre al origin main)
